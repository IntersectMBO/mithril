...
use crate::{
    ...
    proof_system::{
        ...
        halo2_snark::{SnarkError, build_snark_message, prover_input::SnarkProverInput},
    },
};
...
pub(crate) trait SnarkAggregateSignatureProver<D: MembershipDigest> {
    ...
    /// using the verification key return by verification_key().
...
mod tests {
    ...
    mod slow {
        ...
        fn fails_with_empty_signatures() {
            ...
            let result: Result<SnarkProof<D>, _> =
    ...
    mod golden {
        ...
        fn golden_aggregate_signature_verifies_with_ancillary() {
            ...
            aggregate
                ...
                .expect("golden Snark aggregate signature must verify via ancillary verifier data");
        }
    }
}
