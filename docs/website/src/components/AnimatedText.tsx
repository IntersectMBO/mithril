...
const AnimatedText: FC = () => {
  return (
    <section className="tablet:component py-24 max-w-![1040px]">
      <motion.div
        variants={{
          hidden: {},
          visible: {
      ...
      >
        {processText(
          <h2 className="animated-text-heading text-blue tablet:tracking-tight tracking-[-0.02rem] tablet:text-center desktop:p-0 pageContainer m-0">
