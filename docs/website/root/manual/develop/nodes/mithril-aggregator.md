...
| `leader_aggregator_endpoint`                                     | `--leader-aggregator-endpoint`                                     |          -           | `LEADER_AGGREGATOR_ENDPOINT`                                                | Leader aggregator endpoint                                                                                                                                                                                                                                         | -               | `https://aggregator.pre-release-preview.api.mithril.network/aggregator`                                                                                                                                                                                                                          |                        -                        |
| `certificate_chain_aggregator_endpoint`                          | `--certificate-chain-aggregator-endpoint`                          |          -           | `CERTIFICATE_CHAIN_AGGREGATOR_ENDPOINT`                                     | Certificate chain aggregator endpoint                                                                                                                                                                                                                              | -               | `https://aggregator.pre-release-preview.api.mithril.network/aggregator`                                                                                                                                                                                                                          |                        -                        |
